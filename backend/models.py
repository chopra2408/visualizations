...
class AgentResponse(BaseModel): # Used by FastAPI, ensure run_agent output matches these fields for typing
    response_type: str
    content: Optional[str] = None
    plot_image_bytes: Optional[str] = None # Will be base64 string from backend
